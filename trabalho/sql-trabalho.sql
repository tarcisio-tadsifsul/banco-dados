...
(
	...
	cpf VARCHAR(11) NOT NULL UNIQUE CHECK (TRIM(cpf) <> ''),
	telefone VARCHAR(14) NOT NULL CHECK (TRIM(telefone) <> ''),
...
VALUES
	...
	(1, 1, 1, '2026-07-09', '2026-07-27', '2026-09-05'),
...
CREATE TABLE IF NOT EXISTS fotos (
	...
	foto_caminho VARCHAR NOT NULL CHECK (TRIM(foto_caminho) <> '')
);
